...
const AuctionWrapper = {
  Main: tw.div`flex lg:flex-row flex-col gap-10 justify-between items-center`,
...
const DesktopAuction: FC<{ tokenId: string; activeAuction?: boolean }> = ({
  tokenId,
